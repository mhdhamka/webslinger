        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center gap-3 ml-auto md:ml-0">
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs font-black uppercase rounded-sm border-2 border-black bg-yellow-400 text-black hover:bg-yellow-300 shadow-comic transition flex items-center gap-1.5 active:translate-y-0.5"
            >
            ...
            <button
              ...
              className="p-1.5 text-xs rounded-sm border-2 border-black bg-black text-white hover:bg-gray-800 shadow-comic transition flex items-center gap-1 active:translate-y-0.5"
            >
          ...
          <div className="w-full max-w-md bg-[#111827] border-4 border-black p-6 shadow-comic-blue rounded-sm text-white">
            <div className="flex items-center justify-between pb-3 border-b-2 border-black mb-4">
              ...
              <button
                ...
                className="p-1 bg-black text-white hover:bg-red-600 border border-black transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-2.5 px-4 rounded-sm border-2 border-black bg-[#1e3a8a] hover:bg-blue-700 text-white font-black uppercase text-xs flex items-center justify-center gap-2 shadow-comic transition active:translate-y-0.5"
              >
                <Download className="w-4 h-4" />
                Export Progress JSON Backup
              </button>

              <label className="w-full py-2.5 px-4 rounded-sm border-2 border-black bg-black hover:bg-gray-800 text-yellow-300 font-black uppercase text-xs flex items-center justify-center gap-2 shadow-comic transition cursor-pointer active:translate-y-0.5">
              ...
              <div className="pt-3 border-t-2 border-black">
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-sm border-2 border-black bg-red-800 hover:bg-red-700 text-white font-black uppercase text-xs flex items-center justify-center gap-2 shadow-comic transition active:translate-y-0.5"
                >
